 ...
 * Virro Project Store
 * 
 * Desarrollado por Kodenca - Consultoría y Desarrollo Web
 * https://kodenca.com
 * 
 * Aplicando mejores prácticas de desarrollo:
...
export const metadata: Metadata = {
  title: 'Virro Project - Moda Urbana Peruana',
  description: 'Tienda de ropa urbana peruana con los mejores polos, poleras y hoodies diseñados en Lima',
  icons: {
    icon: '/logo.png',
  },
}
      ...
      <body className={inter.className}>
        <CartProvider>
          <div className="announcement-bar bg-black text-white text-xs py-2 text-center">
            ENVÍO GRATIS: LIMA PEDIDOS SUPERIORES A S/150 | PROVINCIAS SUPERIORES A S/250
          </div>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><a href="#" className="text-sm hover:underline">Poleras</a></li>
                    <li><a href="#" className="text-sm hover:underline">Polos</a></li>
                    <li><a href="#" className="text-sm hover:underline">Joggers</a></li>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><a href="#" className="text-sm hover:underline">Andino</a></li>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><a href="#" className="text-sm hover:underline">Tiendas en Perú</a></li>
              ...
              <div className="border-t border-gray-200 pt-8 flex flex-col items-center">
                ...
                <p className="text-xs text-gray-500 mb-6 text-center">
                  &copy; {new Date().getFullYear()} Virro Project. Diseñado en Lima, Perú. Todos los derechos reservados.
                </p>
              </div>
              
              {/* Sección Kodenca */}
              <div className="border-t border-gray-100 pt-8 pb-2 mt-2">
                <div className="flex flex-col items-center">
                  <div className="flex items-center mb-2">
                    <span className="text-xs uppercase tracking-wider text-gray-400 mr-2">Desarrollado por</span>
                    <a 
                      href="https://kodenca.com" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="flex items-center hover:opacity-80 transition-opacity"
                    >
                      <span className="font-semibold text-sm tracking-wide">KODENCA</span>
                    </a>
                  </div>
                  <p className="text-center text-xs text-gray-400">
                    Consultoría & Desarrollo Web • Aplicando mejores prácticas de desarrollo
                  </p>
                </div>
              </div>
            </div>
